...
public class CustomerRepositoryTests {
	...
	public void testCreateCustomer1() {
		Integer countryId = 2; // Sri Lanka
		Country country = entityManager.find(Country.class, countryId);

		Customer customer = new Customer();
		customer.setCountry(country);
		customer.setFirstName("Deumi");
		customer.setLastName("Ferndo");
		customer.setPassword("password123");
		customer.setEmail("deumi@gmail.com");
		customer.setPhoneNumber("312-462-7518");
		customer.setAddressLine1("1927  Temple Road");
		customer.setCity("Galle");
		customer.setState("Southern");
